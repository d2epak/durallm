...
from durallm.protocol.gemini import clean_gemini_schema  # noqa: F401  (re-exported)
...
def anthropic_to_openai_request(anthropic_req: Dict[str, Any], model_name: str) -> Dict[str, Any]:
    ...
    if "max_tokens" in anthropic_req:
        openai_req["max_tokens"] = min(anthropic_req["max_tokens"], 8192)
    else:
        openai_req["max_tokens"] = 8192
