...
from durallm.errors import NonRecoverableFailureError
...
from durallm.models import FailoverReason, FailureCategory, FailureClassification
...
class TestExecutorHonoursClassification(unittest.TestCase):
    ...
    def test_failure_with_fallback_forbidden_raises_without_trying_other_endpoints(self):
        ...
        with patch("durallm.execution.executor.classify_failure", return_value=forbidden):
